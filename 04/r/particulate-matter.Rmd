...
```{r stan-compile-weak-priors, results="hide"}
...
*Note the `r dim(log_pm_weak)[1]` rows is a result of the 2980 observations \* 1 chain \* 300/2 iterations (1/2 are lost to burn in)*
...
Compile this stan model.
```{r stan-compile-priors, results="hide"}
...
```
Compile this stan model.
```{r stan-compile-regression, results="hide"}
